...
**POC 0 note:** This POC uses a simplified approach — local movement updates immediately and we broadcast transforms. True input-based prediction with sequence numbers and server reconciliation is deferred to later POCs (see the Pitfall section below for details).
