...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="flex flex-col mx-auto px-4 py-16 max-w-4xl [&>header]:prose [&>header]:prose-sm [&>section]:prose [&>section]:prose-sm">
        {/* Header */}
        <header>
        ...
        <section>
          ...
          <p>
            ...
            responds to player noise, economic systems that create real tension,
            and cooperative objectives that demand actual teamwork.
          </p>
          <p>
          ...
          <p>
            So we flipped the process. Instead of building first and documenting
            later, we asked:
        ...
        <section>
          ...
          <p>
            You&apos;re an Operator from the Echelon Group—corporate mercenaries
            in a fractured megacity. Every job sounds simple: get in, hit
          ...
          <p>
            ...
            draws attention you can&apos;t afford. Three strikes and you&apos;re
            fired—new operator, empty wallet, start over.
          </p>
          <p>The systems we needed to prove:</p>
          <ul>
            <li>
              <strong>Destruction as Strategy</strong> — Environment as toolkit,
              not backdrop
            </li>
            <li>
              <strong>Heat as Consequence</strong> — Escalating tension without
              frustration
            </li>
            <li>
              <strong>Dynamic Co-op Objectives</strong> — Real cooperation, not
              parallel solo play
            </li>
            <li>
              <strong>Economic Pressure</strong> — Interesting choices, not just
              annoyance
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            Then we mapped those questions to prototypes. Each POC isolates one
            risky assumption. Each has one job: prove that a specific mechanic
            is solvable—and fun. The questions give each prototype clear success
            criteria.
          </p>
          <p>
            This structure makes AI collaboration work. With explicit questions
            and a consistent template—
            <strong>Hypothesis → Experiment → Results → Decision</strong>—the AI
            has context. It can maintain consistency across sessions. It knows
            what we&apos;re actually trying to prove.
          </p>
          <p>
            We document as we go. Each prototype stands alone. Together, they
            show what Echelon could be and what we learned building it—about the
            game and about the process.
          </p>
        </section>
