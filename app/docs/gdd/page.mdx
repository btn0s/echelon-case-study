export const metadata = {
  ...
  description: "Echelon: Co-op heist game where careful plans meet cartoon physics and desperate people make impossible choices under superhero-level pressure.",
}
